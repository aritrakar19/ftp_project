...
import { Lock, Mail, Camera, AlertCircle, CheckCircle } from 'lucide-react';
...
const Login = () => {
  ...
  const handleValidations = () => {
    if (!email || !password) { setError('All fields are required'); return false; }
    ...
    <div className="flex items-center justify-center min-h-[85vh] px-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? <SpinnerWhite /> : 'Sign In'}
          </button>
        </form>
